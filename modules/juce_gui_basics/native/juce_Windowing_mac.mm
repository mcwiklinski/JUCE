...
static Image createNSWindowSnapshot (NSWindow* nsWindow)
{
    ...
    //     return result;
        ...
        // Create an empty ARGB image with the same dimensions as the window
        Image emptyImage(Image::ARGB, width, height, true);

        // Clear the image (this will make it transparent)
